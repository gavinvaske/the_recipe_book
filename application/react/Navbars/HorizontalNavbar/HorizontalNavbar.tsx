          ...
          <ul className="full-width flex-center-left-row main-navbar-links">
              ...
              <li className="navbar-links nav-dropdown-trigger" id="insights-dropdown-trigger">
                  <div className="insights flex-center-center-row">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-chevron-down"><polyline points="6 9 12 15 18 9"></polyline></svg>
                  </div>

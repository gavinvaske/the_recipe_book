...
describe('filePlanService.js', () => {
    ...
    describe('buildFilePlan()', () => {
        ...
        // TODO (7-8-2023): The code is incorrectly selecting 1 master group instead of 2 master groups.. To fix the algorithm, add a "fridge check": Check all master group sizes to see if any that don't create waste can be formed... if not, lower expectations and check again
                ...
                masterGroups: [
                    {
                        labelsAcross,
                        labelsAround,
                        originalFrames: computeOriginalFrames([product1, product4, product3, product6], frameSize),
                        products: [
                            {
                                name: product1.name,
                        ...
                        totalFrames: Math.ceil(product1.labelQuantity / 3 / labelsAround)
                    },
                    {
                        labelsAcross,
                        labelsAround,
                        originalFrames: computeOriginalFrames([product3, product5], frameSize),
                        products: [
                            {
                                name: product2.name,
                        ...
                        totalFrames: Math.ceil(product2.labelQuantity / 4 / labelsAround)
                    },
                ],
                numberOfMasterGroups: 2,
                totalProducts: products.length,
